...
<br />
As befitting the name, I disavow any topical continuity.<br />
...
Board member, [Stiftung Anoma](https://zg.chregister.ch/cr-portal/auszug/auszug.xhtml?uid=CHE-264.379.335). Research lead, [Heliax](https://heliax.dev).

Previously, I worked as a researcher for [Interchain GmbH](https://interchain.berlin) and as a cofounder of [Metastate](https://metastate.ch/). Before that, I led [CUAUV](https://cuauv.org) and cofounded [Stash.ai](https://stash.ai).
